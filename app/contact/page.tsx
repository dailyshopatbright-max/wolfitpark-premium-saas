...
const contactInfo = [
  ...
  { icon: MapPin, label: "Office", value: "30 N Gould St, Sheridan, WY 82801", href: "https://maps.google.com/?q=30+N+Gould+St+Sheridan+WY+82801", description: "Virtual meetings available globally." },
